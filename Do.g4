...
type:  '*'? (typename | structdefinition | behavourdefinition); // TODO: лямбды 
...
fieldname: NAME;
argumentname: NAME;
typename: DIVIDEDNAME genericparamslist?;
...
// do f<T1, T2, ...> (argname typename, ...) returnType {}
// do f<T1, T2, ...> (self typename) (argname typename, ...) returnType {}
// do f<T1, T2, ...> [typename] (argname typename, ...) returnType {}
// with varname typename
// with varname = typename{}
// with varname = do () returnType {}
// event.Register(do () {})
